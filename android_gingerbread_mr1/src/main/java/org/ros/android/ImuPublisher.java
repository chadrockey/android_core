...
public class ImuPublisher implements NodeMain {
    ...
    private class ImuThread extends Thread {
        ...
        private ImuThread(SensorManager sensorManager, SensorListener sensorListener) {
            ...
            this.quaternionSensor = this.sensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR);
        }
    ...
    public GraphName getDefaultNodeName() {
        return GraphName.of("android_/imu_publisher");
    }
    ...
    public void onStart(ConnectedNode node) {
        try {
            this.publisher = node.newPublisher("android/imu", "sensor_msgs/Imu"); //TODO Allow config
            ...
            List<Sensor> quaternionList = this.sensorManager.getSensorList(Sensor.TYPE_ROTATION_VECTOR);
